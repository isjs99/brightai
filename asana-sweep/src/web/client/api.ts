...
export const api = {
  ...
  findContacts: (prospectId: number, opts: { domain?: string; company?: string } = {}) => call<BdData & { found: number; prospect: BdProspect }>('POST', `/bd/prospects/${prospectId}/find-contacts`, opts),
  ...
  patchLead: (id: number, patch: { sourced_by_id?: number | null; onboarding_id?: number | null }) => call<LeadsData & { lead: Lead }>('PATCH', `/leads/${id}`, patch),
