...
export const api = {
  ...
  fastmossTest: () => call<BdData & { token_path: string | null; shop_search_path: string | null; rows: number; error: string | null }>('POST', '/bd/fastmoss/test'),
  ...
  fastmossSettings: (b: { paths?: string; markets?: string; pages?: number; enabled?: boolean; cron?: string }) => call<BdData>('PUT', '/bd/fastmoss/settings', b),
