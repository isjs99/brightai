      ...
      <div className="page-head">
        ...
        <div className="actions">
          ...
          {!data.fastmoss.configured
            ? <span className="badge muted" title="Set FASTMOSS_API_KEY in .env (developers.fastmoss.com > MCP&CLI > API Keys) for the server to pull FastMoss itself">FastMoss not set</span>
